        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <div className="flex flex-col items-center justify-center space-y-8">
              <div className="text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link href="/pages/tips" className="bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold py-4 px-8 rounded-full hover:from-blue-500 hover:to-purple-500 transition-all shadow-lg hover:shadow-blue-500/20 transform hover:scale-105 uppercase tracking-wider inline-block">
                    Try Tip Tracker
                  </Link>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="md:w-2/3 text-left">
                ...
                <p className="text-gray-300 mb-6">
                  Our advanced analytics reveal hidden patterns in your earnings, helping you identify your most profitable shifts, locations, and strategies.
                </p>
                ...
                <div className="bg-black/50 backdrop-blur-sm rounded-xl p-6 border border-yellow-500/30 transform hover:scale-105 transition-all duration-300 text-center">
                  ...
                  <ul className="text-left space-y-3 mb-6">
                    <li className="flex items-start">
                      ...
                      <span className="text-sm">Advanced earnings insights</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-green-500 mr-2">✓</span>
                    ...
                    <li className="flex items-start">
                      <span className="text-green-500 mr-2">✓</span>
                      <span className="text-sm">Data export & reporting tools</span>
                    </li>
                  </ul>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
            ...
            <div className="bg-black/30 backdrop-blur-sm border border-gray-800 rounded-xl p-6 hover:border-purple-500 transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-purple-500/20">
              ...
              <p className="text-gray-400">See your earnings visualized with beautiful charts and calendars.</p>
            </div>
